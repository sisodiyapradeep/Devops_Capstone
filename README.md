...
The internal and external both use the following npm packages:
 ...
 # deploying the App locally on Amazon Linux EC2 machine (deployment server)
 ...
 1. Getting started:  
    1. Using the deployment server:  
        ...
        1. open two separate terminal sessions:  
            * in one terminal **cd Devops_Capstone/internal**  
            * in the other terminal **cd Devops_Capstone/external**  
...
## Building and deploying the App using docker, K8S and Jenkins
